...
(async () => {
  try {
    ...
    console.log(`✓ SQLite database created: ${localDbPath}\n`);
    ...
    console.log('✓ Sync complete! Local database ready for queries.');
    console.log('\nUsage:');
    console.log('  - Query data from SQLite locally (no remote calls)');
    console.log('  - Export: map-data-export.csv');
